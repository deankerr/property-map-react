...
export default function Listing(props) {
  ...
  if (faves.filter((listing) => listing.id == params.id).length > 0) {
    faveButton = <Button onClick={() => removeFave(result)}>💔 Remove from favourites</Button>
  } else {
    faveButton = <Button onClick={() => addFave(result)}>❤️ Add to favourites</Button>
  }
        ...
        <>
          ...
          <Row className="text-center">
            ...
            <Col xl={7}>
              <Row className="align-items-center">
                <Col xs={1} className="px-0">
                  <Button variant="outline-secondary" onClick={handleLeftButtonClick}>
                    &lt;
                  </Button>
                </Col>
                <Col className="px-0">
                ...
                <Col xs={1} className="px-0">
                  <Button variant="outline-secondary" onClick={handleRightButtonClick}>
                    &gt;
                  </Button>
                </Col>
              </Row>
            ...
            <Col xl={5} className="pe-4">
              ...
              <p>
                {propertyTypes[0]} &mdash; {priceDetails.displayPrice}
              </p>
